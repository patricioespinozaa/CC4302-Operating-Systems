...
Ud. debe programar la funcion solicitada en el archivo compartir.c.
...
+ make run-thr debe felicitarlo y no debe reportar datarace
...
Entregue por U-cursos el archivo compartir.zip
