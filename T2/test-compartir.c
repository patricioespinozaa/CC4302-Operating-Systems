...
int main() {
  ...
  {
    printf("Primer test: se invoca 1 acceder despues de compartir\n");
    pthread_t accede;
    pthread_create(&accede, 0, accede_fun, NULL); // sleep(1)
    compartir(r);
  ...
  {
    printf("2do. test: se invoca 1 acceder antes que compartir\n");
    pthread_t accede;
    pthread_create(&accede, 0, accede_fun, "don't sleep");
    sleep(1);
    compartir(r);
    pthread_join(accede, NULL);
  ...
  printf("Se hicieron %d llamadas a compartir\n", llamadas);
